...
import com.example.haseeb.tabactivity.features.userRepository.RepositoryOwner;
import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class RepositoryModels implements Parcelable {
    ...
    protected RepositoryModels(Parcel in) {
        if (in.readByte() == 0) {
            id = null;
        } else {
            id = in.readInt();
        ...
        owner = in.readParcelable(RepositoryOwner.class.getClassLoader());
    ...
    public static final Creator<RepositoryModels> CREATOR = new Creator<RepositoryModels>() {
        @Override
        public RepositoryModels createFromParcel(Parcel in) {
            return new RepositoryModels(in);
        }

        @Override
        public RepositoryModels[] newArray(int size) {
            return new RepositoryModels[size];
        }
    };
